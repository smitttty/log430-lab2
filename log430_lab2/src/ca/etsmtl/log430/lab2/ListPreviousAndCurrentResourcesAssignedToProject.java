...
public class ListPreviousAndCurrentResourcesAssignedToProject extends Communication {


	public ListPreviousAndCurrentResourcesAssignedToProject(Integer registrationNumber,
	...
	public void update(Observable thing, Object notificationNumber) {
		...
		if (registrationNumber.compareTo((Integer) notificationNumber) == 0) {
			...
			if (myProject != null) {
				 ...
				 */
				display.displayResourcesAlreadyAssignedToProject(myProject.getID(), CommonData.theListOfResources.getListOfResources());
