...
public class ListPreviousProjectsAssignedToPreviousResource extends Communication {

	public ListPreviousProjectsAssignedToPreviousResource(Integer registrationNumber,
	...
	public void update(Observable thing, Object notificationNumber) {
		...
		if (registrationNumber.compareTo((Integer) notificationNumber) == 0) {
			 ...
			 */
			if (myResource != null) {
				display.displayProjectsAlreadyAssignedToResource(myResource, CommonData.theListOfProjects.getListOfProjects());
			} else {
				System.out.println("\n\n *** Resource not found ***");
			}
		}
